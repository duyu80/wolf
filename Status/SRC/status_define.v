...
//`define	OSCH		//if define this, the system will use internal OSC
`ifndef SIM
`define	SIM_CHECKSUM
`endif
...
`define	ACT_LED_DFT         36'h0
`define	FLT_LED_DFT         36'h0
`define	IDLE                8'b0000_0001
`define	ACT_RECV            8'b0000_0010
`define	NULL_RECV           8'b0000_0100
`define	FLT_RECV            8'b0000_1000
`define	END                 8'b0001_0000
`define	DAP_DELAY_WIDTH		32
`define	DAP_DELAY           `DAP_DELAY_WIDTH'hff
`define	SGPIO_TIMEOUT       25'd25000000
